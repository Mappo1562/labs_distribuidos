...
func (c *coordinadorRYWClient) GetSeats(ctx context.Context, in *GetSeatsRequest, opts ...grpc.CallOption) (*GetSeatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinadorRYW_GetSeats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coordinadorRYWClient) CheckIn(ctx context.Context, in *CheckInRequest, opts ...grpc.CallOption) (*CheckInResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinadorRYW_CheckIn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coordinadorRYWClient) GetBoardingPass(ctx context.Context, in *GetBoardingPassRequest, opts ...grpc.CallOption) (*GetBoardingPassResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinadorRYW_GetBoardingPass_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCoordinadorRYWServer must be embedded to have
...
func (UnimplementedCoordinadorRYWServer) testEmbeddedByValue()                        {}
...
func RegisterCoordinadorRYWServer(s grpc.ServiceRegistrar, srv CoordinadorRYWServer) {
	// If the following call pancis, it indicates UnimplementedCoordinadorRYWServer was
