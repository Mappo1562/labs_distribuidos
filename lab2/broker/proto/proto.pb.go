...
var file_proto_proto_proto_rawDesc = []byte{
	...
	0x79, 0x62, 0x65, 0x72, 0x44, 0x61, 0x79, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x22, 0x00, 0x42, 0x08,
...
var file_proto_proto_proto_depIdxs = []int32{
	...
	2, // 3: CyberDay.Broker.GenerarOferta:output_type -> CyberDay.Bool
	2, // 4: CyberDay.Broker.Registrarse:output_type -> CyberDay.Bool
	2, // 5: CyberDay.NodeService.GuardarOferta:output_type -> CyberDay.Bool
