...
const file_proto_proto_proto_rawDesc = "" +
	...
	"\x03rol\x18\x02 \x01(\x05R\x03rol\"\xbb\x01\n" +
	"\x06Oferta\x12\x1b\n" +
	...
	"\x05fecha\x18\a \x01(\tR\x05fecha\"\x1a\n" +
	"\x04Bool\x12\x12\n" +
	"\x04flag\x18\x01 \x01(\bR\x04flag\"8\n" +
	"\fStoreRequest\x12(\n" +
	...
	"\vRegistrarse\x12\x12.CyberDay.Registro\x1a\x0e.CyberDay.Bool\"\x002B\n" +
	"\vNodeService\x123\n" +
	"\rGuardarOferta\x12\x10.CyberDay.Oferta\x1a\x0e.CyberDay.Bool\"\x002\xbf\x01\n" +
	"\x06DBNode\x128\n" +
...
var file_proto_proto_proto_goTypes = []any{
	...
	(*StoreRequest)(nil),       // 3: CyberDay.StoreRequest
	(*StoreResponse)(nil),      // 4: CyberDay.StoreResponse
	(*GetRequest)(nil),         // 5: CyberDay.GetRequest
	(*GetResponse)(nil),        // 6: CyberDay.GetResponse
	(*RangeSinceRequest)(nil),  // 7: CyberDay.RangeSinceRequest
	(*RangeSinceResponse)(nil), // 8: CyberDay.RangeSinceResponse
	(*Vacio)(nil),              // 9: CyberDay.Vacio
}
var file_proto_proto_proto_depIdxs = []int32{
	...
	3, // 6: CyberDay.DBNode.Store:input_type -> CyberDay.StoreRequest
	5, // 7: CyberDay.DBNode.Get:input_type -> CyberDay.GetRequest
	7, // 8: CyberDay.DBNode.RangeSince:input_type -> CyberDay.RangeSinceRequest
	2, // 9: CyberDay.Broker.GenerarOferta:output_type -> CyberDay.Bool
	2, // 10: CyberDay.Broker.Registrarse:output_type -> CyberDay.Bool
	2, // 11: CyberDay.NodeService.GuardarOferta:output_type -> CyberDay.Bool
	4, // 12: CyberDay.DBNode.Store:output_type -> CyberDay.StoreResponse
	6, // 13: CyberDay.DBNode.Get:output_type -> CyberDay.GetResponse
	8, // 14: CyberDay.DBNode.RangeSince:output_type -> CyberDay.RangeSinceResponse
