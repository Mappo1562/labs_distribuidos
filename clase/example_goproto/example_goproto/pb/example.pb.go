...
const file_example_proto_rawDesc = "" +
	...
	"\bResponse\x12\x18\n" +
	"\aMessage\x18\x01 \x01(\x05R\aMessage2H\n" +
	"\x12CordinationService\x122\n" +
	"\vCordination\x12\x10.example.Request\x1a\x11.example.ResponseB\x16Z\x14./example_goproto/pbb\x06proto3"
...
var file_example_proto_depIdxs = []int32{
	0, // 0: example.CordinationService.Cordination:input_type -> example.Request
	1, // 1: example.CordinationService.Cordination:output_type -> example.Response
