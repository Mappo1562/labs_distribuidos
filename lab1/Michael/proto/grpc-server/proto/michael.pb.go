...
const file_michael_proto_rawDesc = "" +
	...
	"\tEstrellas\x126\n" +
	"\x16EmpezarMandarEstrellas\x12\r.Atraco.Vacio\x1a\r.Atraco.Stars\x127\n" +
	"\x17TerminarMandarEstrellas\x12\r.Atraco.Stars\x1a\r.Atraco.VacioB\x13Z\x11grpc-server/protob\x06proto3"
